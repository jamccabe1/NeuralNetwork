...
def defineFlags():
    ...
    parser.add_argument('-mb','--MINIBATCH_SIZE',type=int, default=1,help='this specifies the number of data points to be included in each mini-batch.')
    parser.add_argument('-nlayers', type=int,default=1,help='this is the number of hidden layers in your neural network.')
    return parser
